...
public class MainActivity extends OrmLiteBaseActivity<DatabaseHelper> {
	...
	public void doNoteDataStuff() throws SQLException {
		...
		//create
		playerDao.create(new Player("player1", "Di"));
		playerDao.create(new Player("player2", "Adric"));
		playerDao.create(new Player("player3", "Andrew"));
		playerDao.create(new Player("player4", "Ed"));
